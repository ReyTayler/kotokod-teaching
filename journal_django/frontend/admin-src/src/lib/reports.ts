...
export const REPORT_TYPES: ReportTypeDef[] = [
  ...
  },
  {
    ...
    desc: 'По каждому ученику и каждой его группе за месяц: направление, основной '
      + 'преподаватель группы, сколько уроков провела группа и на скольких был ученик. '
      + 'Ученик из двух групп даёт две строки — по одной на преподавателя. '
      + '45-минутное занятие считается за 0,5 урока.',
    buildParams: (year, month) => ({ month: ym(year, month) }),
  },
];
