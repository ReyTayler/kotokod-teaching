...
import { resolveDirectionColor, NO_DIRECTION_COLOR } from '../../lib/subjects';
...
export default function CalendarPage() {
   ...
   * запросом (окно ≤92 дней укладывается с запасом). /api/calendar уже
   * скоупит на текущего преподавателя на сервере.
   */
  ...
  const { data, isLoading, isError, isFetching } = useCalendar(windowFrom, windowTo);
