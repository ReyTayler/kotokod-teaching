...
import { parseIsoDate, columnIndexOfIsoDate, dayMonth } from '../../lib/dates';

const DAY_FULL = ['Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье'];

/**
 * Read-only детали занятия (Occurrence из /api/calendar) + необязательная
 * кнопка «Отметить урок» (форма submitLesson живёт в components/lessons/
 * LessonForm — привязка через onSubmit, существующие вызовы без onSubmit не
 * ломаются).
 */
