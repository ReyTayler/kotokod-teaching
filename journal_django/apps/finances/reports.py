...
события — включая доп.уроки (в новой модели компенсации потребление идёт от
самого факта доп.урока, поэтому его собственная lesson_date = дата проведения
естественно относит деньги к месяцу доп.урока, без отдельного ремаппинга) и
«сгоревшие» пропуски, отмеченные задним числом через update_attendance_cell
(учитываются в месяце самой ПРАВКИ, не в месяце урока — см.
LessonAttendance.burned_at).
