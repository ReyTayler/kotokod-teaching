...
def direction_fixture():
    ...
    with connection.cursor() as cur:
        cur.execute(
            ...
            VALUES ('__spa_test_dir__', '__spa_sheet__', false, 8, true)
            RETURNING id
            """,
        )
...
def group_fixture(teacher_fixture, direction_fixture):
    ...
    with connection.cursor() as cur:
        cur.execute(
            ...
            VALUES ('__spa_test_group__ пн 10:00', %s, %s, false, 60, true)
            RETURNING id
            """,
...
def half_group_fixture(teacher_fixture, direction_fixture):
    ...
    with connection.cursor() as cur:
        cur.execute(
            ...
            INSERT INTO groups (name, direction_id, teacher_id, is_individual,
                                lesson_duration_minutes, active)
            VALUES ('__spa_half_group__ 45 минут вт 11:00', %s, %s, false, 45, true)
            RETURNING id
            """,
            [direction_fixture, teacher_id],
        )
